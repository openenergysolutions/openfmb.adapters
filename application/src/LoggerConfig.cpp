...
namespace openfmb
{
    ...
    namespace logging
    {
        ...
        Logger create_logger_from_yaml(const YAML::Node& root)
        {
            ...
            const auto primary_log_name = yaml::require(logging, openfmb::keys::logger_name).as<std::string>();
            ...
            if (yaml::require(console, openfmb::keys::enabled).as<bool>())
            {
            ...
            if (yaml::require(rotating, openfmb::keys::enabled).as<bool>())
            {
                sinks.push_back(
        ...
        void write_default_logging_config(YAML::Emitter& out)
        {
            ...
            out << YAML::BeginMap;
            /**/out << YAML::Key << openfmb::keys::logger_name << YAML::Value << "application";
            /**/out << YAML::Key << keys::console << YAML::Comment("log messages to the console");
            /**/out << YAML::BeginMap;
            /**//**/out << YAML::Key << openfmb::keys::enabled << YAML::Value << true;
            /**/out << YAML::EndMap;
            /**/out << YAML::Key << keys::rotating_file << YAML::Comment("log messages to rotating files");
            /**/out << YAML::BeginMap;
            /**//**/out << YAML::Key << openfmb::keys::enabled << YAML::Value << false;
