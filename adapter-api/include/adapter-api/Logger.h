...
public:
    ...
    Logger(const std::string& name, const SinkCollection& sinks)
        : Logger(create(name, sinks))
    {
    }
    ...
    template <typename T>
    inline void critical(const T& arg)
    {
