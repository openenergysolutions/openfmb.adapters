...
void visit_commonmodule_EnergyConsumer(const set_t<commonmodule::EnergyConsumer>& setter, const get_t<commonmodule::EnergyConsumer>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ControlFSCC(const set_t<commonmodule::ControlFSCC>& setter, const get_t<commonmodule::ControlFSCC>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_loadmodule_LoadControlScheduleFSCH(const set_t<loadmodule::LoadControlScheduleFSCH>& setter, const get_t<loadmodule::LoadControlScheduleFSCH>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_IED(const set_t<commonmodule::IED>& setter, const get_t<commonmodule::IED>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_google_protobuf_StringValue(const set_t<google::protobuf::StringValue>& setter, const get_t<google::protobuf::StringValue>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_loadmodule_LoadControlFSCC(const set_t<loadmodule::LoadControlFSCC>& setter, const get_t<loadmodule::LoadControlFSCC>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_SchedulePoint(const set_t<commonmodule::SchedulePoint>& setter, const get_t<commonmodule::SchedulePoint>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_Unit(const set_t<commonmodule::Unit>& setter, const get_t<commonmodule::Unit>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_loadmodule_LoadControl(const set_t<loadmodule::LoadControl>& setter, const get_t<loadmodule::LoadControl>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ControlValue(const set_t<commonmodule::ControlValue>& setter, const get_t<commonmodule::ControlValue>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_Optional_StateKind(const set_t<commonmodule::Optional_StateKind>& setter, const get_t<commonmodule::Optional_StateKind>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_MessageInfo(const set_t<commonmodule::MessageInfo>& setter, const get_t<commonmodule::MessageInfo>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_google_protobuf_FloatValue(const set_t<google::protobuf::FloatValue>& setter, const get_t<google::protobuf::FloatValue>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_loadmodule_LoadPoint(const set_t<loadmodule::LoadPoint>& setter, const get_t<loadmodule::LoadPoint>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ControlMessageInfo(const set_t<commonmodule::ControlMessageInfo>& setter, const get_t<commonmodule::ControlMessageInfo>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_IdentifiedObject(const set_t<commonmodule::IdentifiedObject>& setter, const get_t<commonmodule::IdentifiedObject>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_google_protobuf_BoolValue(const set_t<google::protobuf::BoolValue>& setter, const get_t<google::protobuf::BoolValue>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ControlDPC(const set_t<commonmodule::ControlDPC>& setter, const get_t<commonmodule::ControlDPC>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_loadmodule_LoadCSG(const set_t<loadmodule::LoadCSG>& setter, const get_t<loadmodule::LoadCSG>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ConductingEquipment(const set_t<commonmodule::ConductingEquipment>& setter, const get_t<commonmodule::ConductingEquipment>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_RampRate(const set_t<commonmodule::RampRate>& setter, const get_t<commonmodule::RampRate>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_NamedObject(const set_t<commonmodule::NamedObject>& setter, const get_t<commonmodule::NamedObject>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ControlTimestamp(const set_t<commonmodule::ControlTimestamp>& setter, const get_t<commonmodule::ControlTimestamp>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_CheckConditions(const set_t<commonmodule::CheckConditions>& setter, const get_t<commonmodule::CheckConditions>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ScheduleCSG(const set_t<commonmodule::ScheduleCSG>& setter, const get_t<commonmodule::ScheduleCSG>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_ControlScheduleFSCH(const set_t<commonmodule::ControlScheduleFSCH>& setter, const get_t<commonmodule::ControlScheduleFSCH>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_LogicalNode(const set_t<commonmodule::LogicalNode>& setter, const get_t<commonmodule::LogicalNode>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_LogicalNodeForControl(const set_t<commonmodule::LogicalNodeForControl>& setter, const get_t<commonmodule::LogicalNodeForControl>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);

void visit_commonmodule_Timestamp(const set_t<commonmodule::Timestamp>& setter, const get_t<commonmodule::Timestamp>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor);
...
void visit_commonmodule_SchedulePoint(const set_t<commonmodule::SchedulePoint>& setter, const get_t<commonmodule::SchedulePoint>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor)
{
    if(visitor.start_message_field("xVal", commonmodule::ControlTimestamp::descriptor()))
    {
        visit_commonmodule_ControlTimestamp(
            ...
            [getter](const loadmodule::LoadControlProfile& profile) -> commonmodule::ControlTimestamp const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_MessageInfo(const set_t<commonmodule::MessageInfo>& setter, const get_t<commonmodule::MessageInfo>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor)
{
    ...
    if(visitor.start_message_field("messageTimeStamp", commonmodule::Timestamp::descriptor()))
    {
        visit_commonmodule_Timestamp(
            ...
            [getter](const loadmodule::LoadControlProfile& profile) -> commonmodule::Timestamp const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_ControlTimestamp(const set_t<commonmodule::ControlTimestamp>& setter, const get_t<commonmodule::ControlTimestamp>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor)
{
    visitor.handle(
        "fraction",
        AccessorBuilder<loadmodule::LoadControlProfile,uint32_t>::build(
            [setter](loadmodule::LoadControlProfile& profile, const uint32_t& value) { setter(profile)->set_fraction(value); },
            [getter](const loadmodule::LoadControlProfile& profile, const handler_t<uint32_t>& handler) { return false; }
        )
    );

    visitor.handle(
        "seconds",
        AccessorBuilder<loadmodule::LoadControlProfile,uint64_t>::build(
            [setter](loadmodule::LoadControlProfile& profile, const uint64_t& value) { setter(profile)->set_seconds(value); },
            [getter](const loadmodule::LoadControlProfile& profile, const handler_t<uint64_t>& handler) { return false; }
        )
    );
}
...
void visit_commonmodule_Timestamp(const set_t<commonmodule::Timestamp>& setter, const get_t<commonmodule::Timestamp>& getter, IConfigModelVisitor<loadmodule::LoadControlProfile>& visitor)
{
    ...
    if(visitor.start_message_field("tq", commonmodule::TimeQuality::descriptor()))
    {
        visit_commonmodule_TimeQuality(
            ...
            [getter](const loadmodule::LoadControlProfile& profile) -> commonmodule::TimeQuality const *
            {
                const auto value = getter(profile);
                if(value)
                {
