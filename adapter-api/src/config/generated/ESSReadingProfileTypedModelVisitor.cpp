#include "adapter-api/config/generated/ESSReadingProfileTypedModelVisitor.h"
...
void visit_commonmodule_Quality(const set_t<commonmodule::Quality>& setter, const get_t<commonmodule::Quality>& getter, ITypedModelVisitor<essmodule::ESSReadingProfile>& visitor);
...
void visit_commonmodule_Timestamp(const set_t<commonmodule::Timestamp>& setter, const get_t<commonmodule::Timestamp>& getter, ITypedModelVisitor<essmodule::ESSReadingProfile>& visitor);
