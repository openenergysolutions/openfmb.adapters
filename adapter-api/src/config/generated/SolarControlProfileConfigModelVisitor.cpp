...
void visit_commonmodule_CheckConditions(const set_t<commonmodule::CheckConditions>& setter, const get_t<commonmodule::CheckConditions>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ConductingEquipment(const set_t<commonmodule::ConductingEquipment>& setter, const get_t<commonmodule::ConductingEquipment>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ControlDPC(const set_t<commonmodule::ControlDPC>& setter, const get_t<commonmodule::ControlDPC>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ControlFSCC(const set_t<commonmodule::ControlFSCC>& setter, const get_t<commonmodule::ControlFSCC>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ControlMessageInfo(const set_t<commonmodule::ControlMessageInfo>& setter, const get_t<commonmodule::ControlMessageInfo>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ControlScheduleFSCH(const set_t<commonmodule::ControlScheduleFSCH>& setter, const get_t<commonmodule::ControlScheduleFSCH>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ControlTimestamp(const set_t<commonmodule::ControlTimestamp>& setter, const get_t<commonmodule::ControlTimestamp>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ControlValue(const set_t<commonmodule::ControlValue>& setter, const get_t<commonmodule::ControlValue>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ENG_GridConnectModeKind(const set_t<commonmodule::ENG_GridConnectModeKind>& setter, const get_t<commonmodule::ENG_GridConnectModeKind>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_IED(const set_t<commonmodule::IED>& setter, const get_t<commonmodule::IED>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_IdentifiedObject(const set_t<commonmodule::IdentifiedObject>& setter, const get_t<commonmodule::IdentifiedObject>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_LogicalNode(const set_t<commonmodule::LogicalNode>& setter, const get_t<commonmodule::LogicalNode>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_LogicalNodeForControl(const set_t<commonmodule::LogicalNodeForControl>& setter, const get_t<commonmodule::LogicalNodeForControl>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_MessageInfo(const set_t<commonmodule::MessageInfo>& setter, const get_t<commonmodule::MessageInfo>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_NamedObject(const set_t<commonmodule::NamedObject>& setter, const get_t<commonmodule::NamedObject>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_Optional_StateKind(const set_t<commonmodule::Optional_StateKind>& setter, const get_t<commonmodule::Optional_StateKind>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_RampRate(const set_t<commonmodule::RampRate>& setter, const get_t<commonmodule::RampRate>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_ScheduleCSG(const set_t<commonmodule::ScheduleCSG>& setter, const get_t<commonmodule::ScheduleCSG>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_SchedulePoint(const set_t<commonmodule::SchedulePoint>& setter, const get_t<commonmodule::SchedulePoint>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_Timestamp(const set_t<commonmodule::Timestamp>& setter, const get_t<commonmodule::Timestamp>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_commonmodule_Unit(const set_t<commonmodule::Unit>& setter, const get_t<commonmodule::Unit>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_google_protobuf_BoolValue(const set_t<google::protobuf::BoolValue>& setter, const get_t<google::protobuf::BoolValue>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_google_protobuf_FloatValue(const set_t<google::protobuf::FloatValue>& setter, const get_t<google::protobuf::FloatValue>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_google_protobuf_StringValue(const set_t<google::protobuf::StringValue>& setter, const get_t<google::protobuf::StringValue>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_solarmodule_SolarCSG(const set_t<solarmodule::SolarCSG>& setter, const get_t<solarmodule::SolarCSG>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_solarmodule_SolarControl(const set_t<solarmodule::SolarControl>& setter, const get_t<solarmodule::SolarControl>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_solarmodule_SolarControlFSCC(const set_t<solarmodule::SolarControlFSCC>& setter, const get_t<solarmodule::SolarControlFSCC>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_solarmodule_SolarControlScheduleFSCH(const set_t<solarmodule::SolarControlScheduleFSCH>& setter, const get_t<solarmodule::SolarControlScheduleFSCH>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_solarmodule_SolarInverter(const set_t<solarmodule::SolarInverter>& setter, const get_t<solarmodule::SolarInverter>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);

void visit_solarmodule_SolarPoint(const set_t<solarmodule::SolarPoint>& setter, const get_t<solarmodule::SolarPoint>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor);
...
void visit_commonmodule_ConductingEquipment(const set_t<commonmodule::ConductingEquipment>& setter, const get_t<commonmodule::ConductingEquipment>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    ...
    visitor.handle(
        ...
        AccessorBuilder<solarmodule::SolarControlProfile,std::string>::build(
            ...
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<std::string>& handler) { return false; }
        )
    );
}
...
void visit_commonmodule_ControlDPC(const set_t<commonmodule::ControlDPC>& setter, const get_t<commonmodule::ControlDPC>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    visitor.handle(
        ...
        AccessorBuilder<solarmodule::SolarControlProfile,bool>::build(
            ...
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<bool>& handler) { return false; }
        )
    );
}
...
void visit_commonmodule_ENG_GridConnectModeKind(const set_t<commonmodule::ENG_GridConnectModeKind>& setter, const get_t<commonmodule::ENG_GridConnectModeKind>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    visitor.handle(
        ...
        AccessorBuilder<solarmodule::SolarControlProfile,int>::build(
            ...
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<int>& handler) { return false; }
        ),
...
void visit_commonmodule_SchedulePoint(const set_t<commonmodule::SchedulePoint>& setter, const get_t<commonmodule::SchedulePoint>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    ...
    visitor.handle(
        ...
        AccessorBuilder<solarmodule::SolarControlProfile,float>::build(
            ...
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<float>& handler) { return false; }
        )
    );
...
void visit_commonmodule_Unit(const set_t<commonmodule::Unit>& setter, const get_t<commonmodule::Unit>& getter, IConfigModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    visitor.handle(
        "multiplier",
        AccessorBuilder<solarmodule::SolarControlProfile,int>::build(
            [setter](solarmodule::SolarControlProfile& profile, const int& value) { setter(profile)->set_multiplier(static_cast<commonmodule::UnitMultiplierKind>(value)); },
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<int>& handler) { return false; }
        ),
