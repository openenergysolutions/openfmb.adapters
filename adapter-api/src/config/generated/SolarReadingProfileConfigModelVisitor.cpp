...
template <class C>
void visit_google_protobuf_FloatValue(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_solarmodule_SolarReading(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_LogicalNode(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_DEL(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_IED(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ConductingEquipment(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_MessageInfo(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_BCR(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_Quality(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_CMV(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_MV(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_google_protobuf_Int32Value(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_PhaseMMTN(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_google_protobuf_BoolValue(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ReadingMMTR(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ACDCTerminal(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_google_protobuf_StringValue(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_Timestamp(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_Terminal(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ConductingEquipmentTerminalReading(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ReadingMessageInfo(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_DetailQual(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ReadingMMXU(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_Vector(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ENG_CalcMethodKind(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_WYE(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_NamedObject(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_IdentifiedObject(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ReadingMMTN(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_AnalogueValue(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_solarmodule_SolarInverter(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_ENG_PFSignKind(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_Unit(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);

template <class C>
void visit_commonmodule_TimeQuality(const C& context, DescriptorPathImpl& path, IConfigModelVisitor<solarmodule::SolarReadingProfile>& visitor);
