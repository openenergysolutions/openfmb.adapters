...
namespace dnp3 {
    namespace outstation {
        ...
        public:
            SubscriptionHandler(std::string mRID, std::shared_ptr<asiodnp3::IOutstation> outstation, update_handler_vec_t<T> handlers);
        ...
        template <class T>
        SubscriptionHandler<T>::SubscriptionHandler(std::string mRID, std::shared_ptr<asiodnp3::IOutstation> outstation, update_handler_vec_t<T> handlers)
            : mRID(std::move(mRID))
