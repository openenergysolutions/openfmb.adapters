...
#ifndef OPENFMB_ADAPTER_DNP3_MASTER_CONTROLCONFIGWRITEVISITOR_H
#define OPENFMB_ADAPTER_DNP3_MASTER_CONTROLCONFIGWRITEVISITOR_H
...
namespace dnp3 {
    ...
    namespace master {
        ...
        private:
            ...
            void write_analog_keys(YAML::Emitter& out, uint16_t index);
        };
    }
}
}
