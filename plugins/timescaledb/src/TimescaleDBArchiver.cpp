...
namespace timescaledb {
    ...
    bool TimescaleDBArchiver::get_column_value(const MessageItem *item, std::string& value, std::string& column_name)
    {
        static const std::map<std::string,std::string> variable_lookup = boost::assign::map_list_of
                (".readingMMXU.A.neut.cVal.mag.f.value", "A_neut_mag")
                (".readingMMXU.A.net.cVal.mag.f.value",  "A_net_mag")
                (".readingMMXU.A.phsA.cVal.mag.f.value", "A_phsA_mag")
                (".readingMMXU.A.phsB.cVal.mag.f.value", "A_phsB_mag")
                (".readingMMXU.A.phsC.cVal.mag.f.value", "A_phsC_mag")

                (".readingMMXU.Hz.mag.f.value", "Hz_mag")

                (".readingMMXU.PF.neut.cVal.mag.f.value", "PF_neut_mag")
                (".readingMMXU.PF.net.cVal.mag.f.value",  "PF_net_mag")
                (".readingMMXU.PF.phsA.cVal.mag.f.value", "PF_phsA_mag")
                (".readingMMXU.PF.phsB.cVal.mag.f.value", "PF_phsB_mag")
                (".readingMMXU.PF.phsC.cVal.mag.f.value", "PF_phsC_mag")

                (".readingMMXU.PhV.neut.cVal.mag.f.value", "PhV_neut_mag")
                (".readingMMXU.PhV.neut.cVal.ang.f.value", "PhV_neut_ang")
                (".readingMMXU.PhV.net.cVal.mag.f.value", "PhV_net_mag")
                (".readingMMXU.PhV.net.cVal.ang.f.value", "PhV_net_ang")
                (".readingMMXU.PhV.phsA.cVal.mag.f.value", "PhV_phsA_mag")
                (".readingMMXU.PhV.phsA.cVal.ang.f.value", "PhV_phsA_ang")
                (".readingMMXU.PhV.phsB.cVal.mag.f.value", "PhV_phsB_mag")
                (".readingMMXU.PhV.phsB.cVal.ang.f.value", "PhV_phsB_ang")
                (".readingMMXU.PhV.phsC.cVal.mag.f.value", "PhV_phsC_mag")
                (".readingMMXU.PhV.phsC.cVal.ang.f.value", "PhV_phsC_ang")

                (".readingMMXU.PPV.phsAB.cVal.mag.f.value", "PPV_phsAB_mag")
                (".readingMMXU.PPV.phsAB.cVal.ang.f.value", "PPV_phsAB_ang")
                (".readingMMXU.PPV.phsBC.cVal.mag.f.value", "PPV_phsBC_mag")
                (".readingMMXU.PPV.phsBC.cVal.ang.f.value", "PPV_phsBC_ang")
                (".readingMMXU.PPV.phsCA.cVal.mag.f.value", "PPV_phsCA_mag")
                (".readingMMXU.PPV.phsCA.cVal.ang.f.value", "PPV_phsCA_ang")

                (".readingMMXU.VA.neut.cVal.mag.f.value", "VA_neut_mag")
                (".readingMMXU.VA.net.cVal.mag.f.value", "VA_net_mag")
                (".readingMMXU.VA.phsA.cVal.mag.f.value", "VA_phsA_mag")
                (".readingMMXU.VA.phsB.cVal.mag.f.value", "VA_phsB_mag")
                (".readingMMXU.VA.phsC.cVal.mag.f.value", "VA_phsC_mag")

                (".readingMMXU.VAr.neut.cVal.mag.f.value", "VAr_neut_mag")
                (".readingMMXU.VAr.net.cVal.mag.f.value", "VAr_net_mag")
                (".readingMMXU.VAr.phsA.cVal.mag.f.value", "VAr_phsA_mag")
                (".readingMMXU.VAr.phsB.cVal.mag.f.value", "VAr_phsB_mag")
                (".readingMMXU.VAr.phsC.cVal.mag.f.value", "VAr_phsC_mag")

                (".readingMMXU.W.neut.cVal.mag.f.value", "W_neut_mag")
                (".readingMMXU.W.net.cVal.mag.f.value", "W_net_mag")
                (".readingMMXU.W.phsA.cVal.mag.f.value", "W_phsA_mag")
                (".readingMMXU.W.phsB.cVal.mag.f.value", "W_phsB_mag")
                (".readingMMXU.W.phsC.cVal.mag.f.value", "W_phsC_mag")
                ;
