...
namespace util {
    ...
    template <>
    struct profile_info<shuntmodule::ShuntControlProfile> {

        static constexpr ProfileType type = ProfileType::Control;

        static const commonmodule::MessageInfo& get_message_info(const shuntmodule::ShuntControlProfile& profile)
        {
            return profile.controlmessageinfo().messageinfo();
        }

        static const commonmodule::ConductingEquipment& get_conducting_equip(const shuntmodule::ShuntControlProfile& profile)
        {
            return profile.shuntsystem().conductingequipment();
        }
    };

    template <>
    struct profile_info<shuntmodule::ShuntDiscreteControlProfile> {

        static constexpr ProfileType type = ProfileType::Control;

        static const commonmodule::MessageInfo& get_message_info(const shuntmodule::ShuntDiscreteControlProfile& profile)
        {
            return profile.controlmessageinfo().messageinfo();
        }

        static const commonmodule::ConductingEquipment& get_conducting_equip(const shuntmodule::ShuntDiscreteControlProfile& profile)
        {
            return profile.shuntsystem().conductingequipment();
        }
    };
    ...
    template <>
    struct profile_info<shuntmodule::ShuntEventProfile> {

        static constexpr ProfileType type = ProfileType::Event;

        static const commonmodule::MessageInfo& get_message_info(const shuntmodule::ShuntEventProfile& profile)
        {
            return profile.eventmessageinfo().messageinfo();
        }

        static const commonmodule::ConductingEquipment& get_conducting_equip(const shuntmodule::ShuntEventProfile& profile)
        {
            return profile.shuntsystem().conductingequipment();
        }
    };
    ...
    template <>
    struct profile_info<shuntmodule::ShuntReadingProfile> {

        static constexpr ProfileType type = ProfileType::Reading;

        static const commonmodule::MessageInfo& get_message_info(const shuntmodule::ShuntReadingProfile& profile)
        {
            return profile.readingmessageinfo().messageinfo();
        }

        static const commonmodule::ConductingEquipment& get_conducting_equip(const shuntmodule::ShuntReadingProfile& profile)
        {
            return profile.shuntsystem().conductingequipment();
        }
    };
    ...
    template <>
    struct profile_info<shuntmodule::ShuntStatusProfile> {

        static constexpr ProfileType type = ProfileType::Status;

        static const commonmodule::MessageInfo& get_message_info(const shuntmodule::ShuntStatusProfile& profile)
        {
            return profile.statusmessageinfo().messageinfo();
        }

        static const commonmodule::ConductingEquipment& get_conducting_equip(const shuntmodule::ShuntStatusProfile& profile)
        {
            return profile.shuntsystem().conductingequipment();
        }
    };
