...
void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor);
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor);
...
void visit_regulatormodule_RegulatorEventAndStatusPoint(const set_t<regulatormodule::RegulatorEventAndStatusPoint>& setter, const get_t<regulatormodule::RegulatorEventAndStatusPoint>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor);
...
void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor)
{
    visitor.handle(
        ...
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_badreference(value); },
    ...
    visitor.handle(
        "failure",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_failure(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inaccurate",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_inaccurate(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inconsistent",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_inconsistent(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oldData",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_olddata(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oscillatory",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_oscillatory(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "outOfRange",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_outofrange(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "overflow",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_overflow(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor)
{
    visitor.handle(
        "clockFailure",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_clockfailure(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        ...
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_clocknotsynchronized(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "leapSecondsKnown",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,bool>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const bool& value) { setter(profile)->set_leapsecondsknown(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "timeAccuracy",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,int>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const int& value) { setter(profile)->set_timeaccuracy(static_cast<commonmodule::TimeAccuracyKind>(value)); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<int>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_regulatormodule_RegulatorEventAndStatusANCR(const set_t<regulatormodule::RegulatorEventAndStatusANCR>& setter, const get_t<regulatormodule::RegulatorEventAndStatusANCR>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor)
{
    ...
    if(visitor.start_message_field("PointStatus", regulatormodule::RegulatorEventAndStatusPoint::descriptor()))
    {
        visit_regulatormodule_RegulatorEventAndStatusPoint(
            ...
            [getter](const regulatormodule::RegulatorStatusProfile& profile) -> regulatormodule::RegulatorEventAndStatusPoint const *
            {
                const auto value = getter(profile);
                if(value)
                {
