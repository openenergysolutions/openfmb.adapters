...
void visit_commonmodule_PhaseSPS(const set_t<commonmodule::PhaseSPS>& setter, const get_t<commonmodule::PhaseSPS>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor);
...
void visit_commonmodule_ASG(const set_t<commonmodule::ASG>& setter, const get_t<commonmodule::ASG>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor)
{
    visitor.handle(
        "setMag",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,double>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const double& value) { setter(profile)->set_setmag(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<double>& handler)
            {
...
void visit_commonmodule_ControlAPC(const set_t<commonmodule::ControlAPC>& setter, const get_t<commonmodule::ControlAPC>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor)
{
    visitor.handle(
        "ctlVal",
        AccessorBuilder<regulatormodule::RegulatorStatusProfile,double>::build(
            [setter](regulatormodule::RegulatorStatusProfile& profile, const double& value) { setter(profile)->set_ctlval(value); },
            [getter](const regulatormodule::RegulatorStatusProfile& profile, const handler_t<double>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_regulatormodule_RegulatorEventAndStatusATCC(const set_t<regulatormodule::RegulatorEventAndStatusATCC>& setter, const get_t<regulatormodule::RegulatorEventAndStatusATCC>& getter, ITypedModelVisitor<regulatormodule::RegulatorStatusProfile>& visitor)
{
    ...
    if(visitor.start_message_field("BndWidHi", commonmodule::PhaseSPS::descriptor()))
    {
        visit_commonmodule_PhaseSPS(
            [setter](regulatormodule::RegulatorStatusProfile& profile)
            {
                return setter(profile)->mutable_bndwidhi();
            },
            [getter](const regulatormodule::RegulatorStatusProfile& profile) -> commonmodule::PhaseSPS const *
            {
                const auto value = getter(profile);
                if(value)
                {
                    return value->has_bndwidhi() ? &value->bndwidhi() : nullptr;
                }
                else
                {
                    return nullptr;
    ...
    if(visitor.start_message_field("BndWidLo", commonmodule::PhaseSPS::descriptor()))
    {
        visit_commonmodule_PhaseSPS(
            [setter](regulatormodule::RegulatorStatusProfile& profile)
            {
                return setter(profile)->mutable_bndwidlo();
            },
            [getter](const regulatormodule::RegulatorStatusProfile& profile) -> commonmodule::PhaseSPS const *
            {
                const auto value = getter(profile);
                if(value)
                {
                    return value->has_bndwidlo() ? &value->bndwidlo() : nullptr;
                }
                else
                {
                    return nullptr;
    ...
    if(visitor.start_message_field("DirCtlRev", commonmodule::PhaseSPS::descriptor()))
    {
        visit_commonmodule_PhaseSPS(
            [setter](regulatormodule::RegulatorStatusProfile& profile)
            {
                return setter(profile)->mutable_dirctlrev();
            },
            [getter](const regulatormodule::RegulatorStatusProfile& profile) -> commonmodule::PhaseSPS const *
            {
                const auto value = getter(profile);
                if(value)
                {
                    return value->has_dirctlrev() ? &value->dirctlrev() : nullptr;
                }
                else
                {
                    return nullptr;
    ...
    if(visitor.start_message_field("DirIndt", commonmodule::PhaseSPS::descriptor()))
    {
        visit_commonmodule_PhaseSPS(
            [setter](regulatormodule::RegulatorStatusProfile& profile)
            {
                return setter(profile)->mutable_dirindt();
            },
            [getter](const regulatormodule::RegulatorStatusProfile& profile) -> commonmodule::PhaseSPS const *
            {
                const auto value = getter(profile);
                if(value)
                {
                    return value->has_dirindt() ? &value->dirindt() : nullptr;
                }
                else
                {
                    return nullptr;
