...
void visit_commonmodule_OperationDCTE(const set_t<commonmodule::OperationDCTE>& setter, const get_t<commonmodule::OperationDCTE>& getter, ITypedModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    visitor.handle(
        "rndDlTmms",
        AccessorBuilder<solarmodule::SolarControlProfile,float>::build(
            [setter](solarmodule::SolarControlProfile& profile, const float& value) { setter(profile)->set_rnddltmms(value); },
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<float>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "rtnDlTmms",
        AccessorBuilder<solarmodule::SolarControlProfile,float>::build(
            [setter](solarmodule::SolarControlProfile& profile, const float& value) { setter(profile)->set_rtndltmms(value); },
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<float>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "rtnRmpTmms",
        AccessorBuilder<solarmodule::SolarControlProfile,float>::build(
            [setter](solarmodule::SolarControlProfile& profile, const float& value) { setter(profile)->set_rtnrmptmms(value); },
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<float>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_OperationDHFW(const set_t<commonmodule::OperationDHFW>& setter, const get_t<commonmodule::OperationDHFW>& getter, ITypedModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    ...
    visitor.handle(
        "OplTmmsMax",
        MessageAccessorBuilder<solarmodule::SolarControlProfile,commonmodule::ClearingTime>::build(
            [setter](solarmodule::SolarControlProfile& profile) { return setter(profile)->mutable_opltmmsmax(); },
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<commonmodule::ClearingTime>& handler)
            {
                const auto parent = getter(profile);
...
void visit_commonmodule_OperationDVVR(const set_t<commonmodule::OperationDVVR>& setter, const get_t<commonmodule::OperationDVVR>& getter, ITypedModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    ...
    visitor.handle(
        "VRefTmms",
        AccessorBuilder<solarmodule::SolarControlProfile,float>::build(
            [setter](solarmodule::SolarControlProfile& profile, const float& value) { setter(profile)->set_vreftmms(value); },
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<float>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_TmHzPoint(const set_t<commonmodule::TmHzPoint>& setter, const get_t<commonmodule::TmHzPoint>& getter, ITypedModelVisitor<solarmodule::SolarControlProfile>& visitor)
{
    ...
    visitor.handle(
        "tmVal",
        MessageAccessorBuilder<solarmodule::SolarControlProfile,commonmodule::ClearingTime>::build(
            [setter](solarmodule::SolarControlProfile& profile) { return setter(profile)->mutable_tmval(); },
            [getter](const solarmodule::SolarControlProfile& profile, const handler_t<commonmodule::ClearingTime>& handler)
            {
                const auto parent = getter(profile);
