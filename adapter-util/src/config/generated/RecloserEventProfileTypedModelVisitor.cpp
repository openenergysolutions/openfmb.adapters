...
void visit_commonmodule_ACD(const set_t<commonmodule::ACD>& setter, const get_t<commonmodule::ACD>& getter, ITypedModelVisitor<reclosermodule::RecloserEventProfile>& visitor);
...
void visit_commonmodule_Optional_PhaseFaultDirectionKind(const set_t<commonmodule::Optional_PhaseFaultDirectionKind>& setter, const get_t<commonmodule::Optional_PhaseFaultDirectionKind>& getter, ITypedModelVisitor<reclosermodule::RecloserEventProfile>& visitor);
...
void visit_commonmodule_ACD(const set_t<commonmodule::ACD>& setter, const get_t<commonmodule::ACD>& getter, ITypedModelVisitor<reclosermodule::RecloserEventProfile>& visitor)
{
    visitor.handle(
        ...
        AccessorBuilder<reclosermodule::RecloserEventProfile,int>::build(
            [setter](reclosermodule::RecloserEventProfile& profile, const int& value) { setter(profile)->set_dirgeneral(static_cast<commonmodule::FaultDirectionKind>(value)); },
    ...
    if(visitor.start_message_field("dirNeut", commonmodule::Optional_PhaseFaultDirectionKind::descriptor()))
    {
        visit_commonmodule_Optional_PhaseFaultDirectionKind(
            ...
            [getter](const reclosermodule::RecloserEventProfile& profile) -> commonmodule::Optional_PhaseFaultDirectionKind const *
            {
                const auto value = getter(profile);
                if(value)
                {
    ...
    visitor.handle(
        ...
        AccessorBuilder<reclosermodule::RecloserEventProfile,bool>::build(
            [setter](reclosermodule::RecloserEventProfile& profile, const bool& value) { setter(profile)->set_general(value); },
...
void visit_commonmodule_Optional_PhaseFaultDirectionKind(const set_t<commonmodule::Optional_PhaseFaultDirectionKind>& setter, const get_t<commonmodule::Optional_PhaseFaultDirectionKind>& getter, ITypedModelVisitor<reclosermodule::RecloserEventProfile>& visitor)
{
    visitor.handle(
        "value",
        AccessorBuilder<reclosermodule::RecloserEventProfile,int>::build(
            [setter](reclosermodule::RecloserEventProfile& profile, const int& value) { setter(profile)->set_value(static_cast<commonmodule::PhaseFaultDirectionKind>(value)); },
            [getter](const reclosermodule::RecloserEventProfile& profile, const handler_t<int>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_StatusAndEventXCBR(const set_t<commonmodule::StatusAndEventXCBR>& setter, const get_t<commonmodule::StatusAndEventXCBR>& getter, ITypedModelVisitor<reclosermodule::RecloserEventProfile>& visitor)
{
    ...
    if(visitor.start_message_field("ProtectionPickup", commonmodule::ACD::descriptor()))
    {
        visit_commonmodule_ACD(
            ...
            [getter](const reclosermodule::RecloserEventProfile& profile) -> commonmodule::ACD const *
            {
                const auto value = getter(profile);
                if(value)
                {
