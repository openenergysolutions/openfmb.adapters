...
void visit_google_protobuf_DoubleValue(const set_t<google::protobuf::DoubleValue>& setter, const get_t<google::protobuf::DoubleValue>& getter, ITypedModelVisitor<loadmodule::LoadReadingProfile>& visitor);
...
void visit_commonmodule_MV(const set_t<commonmodule::MV>& setter, const get_t<commonmodule::MV>& getter, ITypedModelVisitor<loadmodule::LoadReadingProfile>& visitor)
{
    visitor.handle(
        "mag",
        AccessorBuilder<loadmodule::LoadReadingProfile,double>::build(
            [setter](loadmodule::LoadReadingProfile& profile, const double& value) { setter(profile)->set_mag(value); },
            [getter](const loadmodule::LoadReadingProfile& profile, const handler_t<double>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
                handler(parent->mag());
...
void visit_commonmodule_Vector(const set_t<commonmodule::Vector>& setter, const get_t<commonmodule::Vector>& getter, ITypedModelVisitor<loadmodule::LoadReadingProfile>& visitor)
{
    if(visitor.start_message_field("ang", google::protobuf::DoubleValue::descriptor()))
    {
        visit_google_protobuf_DoubleValue(
            ...
            [getter](const loadmodule::LoadReadingProfile& profile) -> google::protobuf::DoubleValue const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_google_protobuf_DoubleValue(const set_t<google::protobuf::DoubleValue>& setter, const get_t<google::protobuf::DoubleValue>& getter, ITypedModelVisitor<loadmodule::LoadReadingProfile>& visitor)
{
    visitor.handle(
        "value",
        AccessorBuilder<loadmodule::LoadReadingProfile,double>::build(
            [setter](loadmodule::LoadReadingProfile& profile, const double& value) { setter(profile)->set_value(value); },
            [getter](const loadmodule::LoadReadingProfile& profile, const handler_t<double>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
