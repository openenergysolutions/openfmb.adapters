...
void visit_google_protobuf_DoubleValue(const set_t<google::protobuf::DoubleValue>& setter, const get_t<google::protobuf::DoubleValue>& getter, ITypedModelVisitor<essmodule::ESSReadingProfile>& visitor);
...
void visit_commonmodule_MV(const set_t<commonmodule::MV>& setter, const get_t<commonmodule::MV>& getter, ITypedModelVisitor<essmodule::ESSReadingProfile>& visitor)
{
    visitor.handle(
        "mag",
        AccessorBuilder<essmodule::ESSReadingProfile,double>::build(
            [setter](essmodule::ESSReadingProfile& profile, const double& value) { setter(profile)->set_mag(value); },
            [getter](const essmodule::ESSReadingProfile& profile, const handler_t<double>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
                handler(parent->mag());
...
void visit_commonmodule_Vector(const set_t<commonmodule::Vector>& setter, const get_t<commonmodule::Vector>& getter, ITypedModelVisitor<essmodule::ESSReadingProfile>& visitor)
{
    if(visitor.start_message_field("ang", google::protobuf::DoubleValue::descriptor()))
    {
        visit_google_protobuf_DoubleValue(
            ...
            [getter](const essmodule::ESSReadingProfile& profile) -> google::protobuf::DoubleValue const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_google_protobuf_DoubleValue(const set_t<google::protobuf::DoubleValue>& setter, const get_t<google::protobuf::DoubleValue>& getter, ITypedModelVisitor<essmodule::ESSReadingProfile>& visitor)
{
    visitor.handle(
        "value",
        AccessorBuilder<essmodule::ESSReadingProfile,double>::build(
            [setter](essmodule::ESSReadingProfile& profile, const double& value) { setter(profile)->set_value(value); },
            [getter](const essmodule::ESSReadingProfile& profile, const handler_t<double>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
