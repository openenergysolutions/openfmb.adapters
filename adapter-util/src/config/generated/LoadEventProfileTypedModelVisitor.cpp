...
void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<loadmodule::LoadEventProfile>& visitor);
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<loadmodule::LoadEventProfile>& visitor);
...
void visit(ITypedModelVisitor<loadmodule::LoadEventProfile>& visitor)
{
    ...
    if(visitor.start_message_field("ied", commonmodule::IED::descriptor()))
    {
        visit_commonmodule_IED(
            ...
            [getter](const loadmodule::LoadEventProfile& profile) -> commonmodule::IED const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<loadmodule::LoadEventProfile>& visitor)
{
    visitor.handle(
        "badReference",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_badreference(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "failure",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_failure(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inaccurate",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_inaccurate(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inconsistent",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_inconsistent(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oldData",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_olddata(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oscillatory",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_oscillatory(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "outOfRange",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_outofrange(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "overflow",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_overflow(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<loadmodule::LoadEventProfile>& visitor)
{
    visitor.handle(
        "clockFailure",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_clockfailure(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        ...
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_clocknotsynchronized(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "leapSecondsKnown",
        AccessorBuilder<loadmodule::LoadEventProfile,bool>::build(
            [setter](loadmodule::LoadEventProfile& profile, const bool& value) { setter(profile)->set_leapsecondsknown(value); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "timeAccuracy",
        AccessorBuilder<loadmodule::LoadEventProfile,int>::build(
            [setter](loadmodule::LoadEventProfile& profile, const int& value) { setter(profile)->set_timeaccuracy(static_cast<commonmodule::TimeAccuracyKind>(value)); },
            [getter](const loadmodule::LoadEventProfile& profile, const handler_t<int>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
