...
void visit_google_protobuf_DoubleValue(const set_t<google::protobuf::DoubleValue>& setter, const get_t<google::protobuf::DoubleValue>& getter, ITypedModelVisitor<switchmodule::SwitchReadingProfile>& visitor);
...
void visit_commonmodule_MV(const set_t<commonmodule::MV>& setter, const get_t<commonmodule::MV>& getter, ITypedModelVisitor<switchmodule::SwitchReadingProfile>& visitor)
{
    visitor.handle(
        "mag",
        AccessorBuilder<switchmodule::SwitchReadingProfile,double>::build(
            [setter](switchmodule::SwitchReadingProfile& profile, const double& value) { setter(profile)->set_mag(value); },
            [getter](const switchmodule::SwitchReadingProfile& profile, const handler_t<double>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
                handler(parent->mag());
...
void visit_commonmodule_Vector(const set_t<commonmodule::Vector>& setter, const get_t<commonmodule::Vector>& getter, ITypedModelVisitor<switchmodule::SwitchReadingProfile>& visitor)
{
    if(visitor.start_message_field("ang", google::protobuf::DoubleValue::descriptor()))
    {
        visit_google_protobuf_DoubleValue(
            ...
            [getter](const switchmodule::SwitchReadingProfile& profile) -> google::protobuf::DoubleValue const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_google_protobuf_DoubleValue(const set_t<google::protobuf::DoubleValue>& setter, const get_t<google::protobuf::DoubleValue>& getter, ITypedModelVisitor<switchmodule::SwitchReadingProfile>& visitor)
{
    visitor.handle(
        "value",
        AccessorBuilder<switchmodule::SwitchReadingProfile,double>::build(
            [setter](switchmodule::SwitchReadingProfile& profile, const double& value) { setter(profile)->set_value(value); },
            [getter](const switchmodule::SwitchReadingProfile& profile, const handler_t<double>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
