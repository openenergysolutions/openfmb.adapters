...
void visit_commonmodule_ControlING(const set_t<commonmodule::ControlING>& setter, const get_t<commonmodule::ControlING>& getter, ITypedModelVisitor<generationmodule::GenerationEventProfile>& visitor);
...
void visit_commonmodule_Unit(const set_t<commonmodule::Unit>& setter, const get_t<commonmodule::Unit>& getter, ITypedModelVisitor<generationmodule::GenerationEventProfile>& visitor);
...
void visit_commonmodule_ControlING(const set_t<commonmodule::ControlING>& setter, const get_t<commonmodule::ControlING>& getter, ITypedModelVisitor<generationmodule::GenerationEventProfile>& visitor)
{
    visitor.handle(
        "setVal",
        AccessorBuilder<generationmodule::GenerationEventProfile,int32_t>::build(
            [setter](generationmodule::GenerationEventProfile& profile, const int32_t& value) { setter(profile)->set_setval(value); },
            [getter](const generationmodule::GenerationEventProfile& profile, const handler_t<int32_t>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    if(visitor.start_message_field("units", commonmodule::Unit::descriptor()))
    {
        visit_commonmodule_Unit(
            ...
            [getter](const generationmodule::GenerationEventProfile& profile) -> commonmodule::Unit const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_OperationDCTE(const set_t<commonmodule::OperationDCTE>& setter, const get_t<commonmodule::OperationDCTE>& getter, ITypedModelVisitor<generationmodule::GenerationEventProfile>& visitor)
{
    if(visitor.start_message_field("rndDlTmms", commonmodule::ControlING::descriptor()))
    {
        visit_commonmodule_ControlING(
            ...
            [getter](const generationmodule::GenerationEventProfile& profile) -> commonmodule::ControlING const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_Unit(const set_t<commonmodule::Unit>& setter, const get_t<commonmodule::Unit>& getter, ITypedModelVisitor<generationmodule::GenerationEventProfile>& visitor)
{
    ...
    visitor.handle(
        "SIUnit",
        AccessorBuilder<generationmodule::GenerationEventProfile,int>::build(
            [setter](generationmodule::GenerationEventProfile& profile, const int& value) { setter(profile)->set_siunit(static_cast<commonmodule::UnitSymbolKind>(value)); },
            [getter](const generationmodule::GenerationEventProfile& profile, const handler_t<int>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
