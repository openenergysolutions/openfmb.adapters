...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<reclosermodule::RecloserDiscreteControlProfile>& visitor);
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<reclosermodule::RecloserDiscreteControlProfile>& visitor)
{
    visitor.handle(
        "clockFailure",
        AccessorBuilder<reclosermodule::RecloserDiscreteControlProfile,bool>::build(
            [setter](reclosermodule::RecloserDiscreteControlProfile& profile, const bool& value) { setter(profile)->set_clockfailure(value); },
            [getter](const reclosermodule::RecloserDiscreteControlProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        ...
        AccessorBuilder<reclosermodule::RecloserDiscreteControlProfile,bool>::build(
            [setter](reclosermodule::RecloserDiscreteControlProfile& profile, const bool& value) { setter(profile)->set_clocknotsynchronized(value); },
            [getter](const reclosermodule::RecloserDiscreteControlProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "leapSecondsKnown",
        AccessorBuilder<reclosermodule::RecloserDiscreteControlProfile,bool>::build(
            [setter](reclosermodule::RecloserDiscreteControlProfile& profile, const bool& value) { setter(profile)->set_leapsecondsknown(value); },
            [getter](const reclosermodule::RecloserDiscreteControlProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        ...
        AccessorBuilder<reclosermodule::RecloserDiscreteControlProfile,int>::build(
            [setter](reclosermodule::RecloserDiscreteControlProfile& profile, const int& value) { setter(profile)->set_timeaccuracy(static_cast<commonmodule::TimeAccuracyKind>(value)); },
