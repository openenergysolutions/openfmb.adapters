...
void visit_commonmodule_ControlDPC(const set_t<commonmodule::ControlDPC>& setter, const get_t<commonmodule::ControlDPC>& getter, ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor);

void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor);
...
void visit_commonmodule_IED(const set_t<commonmodule::IED>& setter, const get_t<commonmodule::IED>& getter, ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor);
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor);
...
void visit(ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor)
{
    ...
    if(visitor.start_message_field("ied", commonmodule::IED::descriptor()))
    {
        visit_commonmodule_IED(
            ...
            [getter](const generationmodule::GenerationStatusProfile& profile) -> commonmodule::IED const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor)
{
    visitor.handle(
        "badReference",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_badreference(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "failure",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_failure(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inaccurate",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_inaccurate(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inconsistent",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_inconsistent(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oldData",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_olddata(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oscillatory",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_oscillatory(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "outOfRange",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_outofrange(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "overflow",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_overflow(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor)
{
    visitor.handle(
        "clockFailure",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_clockfailure(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        ...
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_clocknotsynchronized(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "leapSecondsKnown",
        AccessorBuilder<generationmodule::GenerationStatusProfile,bool>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const bool& value) { setter(profile)->set_leapsecondsknown(value); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "timeAccuracy",
        AccessorBuilder<generationmodule::GenerationStatusProfile,int>::build(
            [setter](generationmodule::GenerationStatusProfile& profile, const int& value) { setter(profile)->set_timeaccuracy(static_cast<commonmodule::TimeAccuracyKind>(value)); },
            [getter](const generationmodule::GenerationStatusProfile& profile, const handler_t<int>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_generationmodule_GenerationPointStatus(const set_t<generationmodule::GenerationPointStatus>& setter, const get_t<generationmodule::GenerationPointStatus>& getter, ITypedModelVisitor<generationmodule::GenerationStatusProfile>& visitor)
{
    if(visitor.start_message_field("blackStartEnabled", commonmodule::ControlDPC::descriptor()))
    {
        visit_commonmodule_ControlDPC(
            ...
            [getter](const generationmodule::GenerationStatusProfile& profile) -> commonmodule::ControlDPC const *
            {
                const auto value = getter(profile);
                if(value)
                {
