...
void visit_commonmodule_AnalogueValue(const set_t<commonmodule::AnalogueValue>& setter, const get_t<commonmodule::AnalogueValue>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor);
...
void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor);
...
void visit_commonmodule_IED(const set_t<commonmodule::IED>& setter, const get_t<commonmodule::IED>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor);
...
void visit_commonmodule_Optional_UnitSymbolKind(const set_t<commonmodule::Optional_UnitSymbolKind>& setter, const get_t<commonmodule::Optional_UnitSymbolKind>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor);
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor);
...
void visit_google_protobuf_FloatValue(const set_t<google::protobuf::FloatValue>& setter, const get_t<google::protobuf::FloatValue>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor);
...
void visit(ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    ...
    if(visitor.start_message_field("ied", commonmodule::IED::descriptor()))
    {
        visit_commonmodule_IED(
            ...
            [getter](const reclosermodule::RecloserReadingProfile& profile) -> commonmodule::IED const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_AnalogueValue(const set_t<commonmodule::AnalogueValue>& setter, const get_t<commonmodule::AnalogueValue>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    if(visitor.start_message_field("f", google::protobuf::FloatValue::descriptor()))
    {
        visit_google_protobuf_FloatValue(
            ...
            [getter](const reclosermodule::RecloserReadingProfile& profile) -> google::protobuf::FloatValue const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_BCR(const set_t<commonmodule::BCR>& setter, const get_t<commonmodule::BCR>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    ...
    if(visitor.start_message_field("units", commonmodule::Optional_UnitSymbolKind::descriptor()))
    {
        visit_commonmodule_Optional_UnitSymbolKind(
            ...
            [getter](const reclosermodule::RecloserReadingProfile& profile) -> commonmodule::Optional_UnitSymbolKind const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_DetailQual(const set_t<commonmodule::DetailQual>& setter, const get_t<commonmodule::DetailQual>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    visitor.handle(
        ...
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_badreference(value); },
    ...
    visitor.handle(
        "failure",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_failure(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inaccurate",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_inaccurate(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "inconsistent",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_inconsistent(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oldData",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_olddata(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "oscillatory",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_oscillatory(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "outOfRange",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_outofrange(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "overflow",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_overflow(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_MV(const set_t<commonmodule::MV>& setter, const get_t<commonmodule::MV>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    if(visitor.start_message_field("mag", commonmodule::AnalogueValue::descriptor()))
    {
        visit_commonmodule_AnalogueValue(
            ...
            [getter](const reclosermodule::RecloserReadingProfile& profile) -> commonmodule::AnalogueValue const *
            {
                const auto value = getter(profile);
                if(value)
                {
...
void visit_commonmodule_Optional_UnitSymbolKind(const set_t<commonmodule::Optional_UnitSymbolKind>& setter, const get_t<commonmodule::Optional_UnitSymbolKind>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    visitor.handle(
        "value",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,int>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const int& value) { setter(profile)->set_value(static_cast<commonmodule::UnitSymbolKind>(value)); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<int>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_commonmodule_TimeQuality(const set_t<commonmodule::TimeQuality>& setter, const get_t<commonmodule::TimeQuality>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    visitor.handle(
        "clockFailure",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_clockfailure(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        ...
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_clocknotsynchronized(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "leapSecondsKnown",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,bool>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const bool& value) { setter(profile)->set_leapsecondsknown(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<bool>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
    ...
    visitor.handle(
        "timeAccuracy",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,int>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const int& value) { setter(profile)->set_timeaccuracy(static_cast<commonmodule::TimeAccuracyKind>(value)); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<int>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
...
void visit_google_protobuf_FloatValue(const set_t<google::protobuf::FloatValue>& setter, const get_t<google::protobuf::FloatValue>& getter, ITypedModelVisitor<reclosermodule::RecloserReadingProfile>& visitor)
{
    visitor.handle(
        "value",
        AccessorBuilder<reclosermodule::RecloserReadingProfile,float>::build(
            [setter](reclosermodule::RecloserReadingProfile& profile, const float& value) { setter(profile)->set_value(value); },
            [getter](const reclosermodule::RecloserReadingProfile& profile, const handler_t<float>& handler)
            {
                const auto parent = getter(profile);
                if(!parent) return false;
                handler(parent->value());
